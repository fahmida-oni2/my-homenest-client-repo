...
// Searching section
  ...
  const showNoResult =
    filteredProperty.length === 0 && search.trim().length > 0;
  return (
    <div className="flex flex-col min-h-screen">
      <div className="pt-10">
        <h1 className="text-4xl font-bold mb-4 animate__animated animate__fadeInDown text-center">
          All Properties
        </h1>
        <p className="text-gray-600 text-center mb-12 animate__animated animate__fadeInUp">

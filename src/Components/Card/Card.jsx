...
const Card = ({property}) => {
  ...
  <div className="card-body space-y-3">
    <h2 className="card-title text-center">{propertyName}</h2>
        <h2 className="card-title text-center">Category:{category}</h2>
         <h2 className="card-title text-center">Location: {location}</h2>
